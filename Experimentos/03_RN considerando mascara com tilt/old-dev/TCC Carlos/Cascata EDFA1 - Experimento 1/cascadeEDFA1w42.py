...
model_name = 'models/nn-42to401.h5'
...
input_set_1 = "data/EDFA1STG_G=14dB@16dBm_Tilt=3.9_Maior_Precisão.xlsx"
...
plt.savefig('results/CascadeEDFA1With42Pins.pdf', dpi = 200)