...
public class TransformPowerMaskToRN_FreqParImpar {

	public static void main(String[] args) {
		PowerMask pm = PowerMaskFactory.getInstance().fabricatePowerMask(AmplifierType.EDFA_1_STG);

		File fileImpar = new File("EDFA_1_STG_Freq_Impar_Filt.txt");
		File filePar = new File("EDFA_1_STG_Freq_Par_Filt.txt");
