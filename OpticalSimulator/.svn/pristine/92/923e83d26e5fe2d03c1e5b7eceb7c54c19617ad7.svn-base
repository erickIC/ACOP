...
public class SimSetAMPVOA_2Amps extends SimulationSetup {

    public SimSetAMPVOA_2Amps(int numberCh, float chPower, float chMaxPower) {
	super.setNumberOfAmplifiers(2);
