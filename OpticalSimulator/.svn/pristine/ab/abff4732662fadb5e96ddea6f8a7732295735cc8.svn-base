...
public class SimSetAMPVOA_3Amps extends SimulationSetup {

    public SimSetAMPVOA_3Amps(int numberCh, float chPower, float chMaxPower) {
	super.setNumberOfAmplifiers(3);
