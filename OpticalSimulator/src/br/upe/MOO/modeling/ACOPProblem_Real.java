 ...
 */
public class ACOPProblem_Real extends AbstractProblem {
     ...
     */
    public ACOPProblem_Real(int numberOfAmplifiers, AmplifierType type) {
	...
	for (int i = 0; i < getNumberOfVariables(); i++) {
		...
		solution.setVariable(i, new RealVariable(pm.getMinGain(), pm.getMaxGain()));
	    } else {
		solution.setVariable(i, new RealVariable(0, (int) MAX_VOA_ATT));
	    }
	}
	...
	ACOPProblem_Real problem = new ACOPProblem_Real(4, AmplifierType.EDFA_2_PadTec);
