...
public class BF_3a extends BFMethod {

    public BF_3a(int numberOfAmplifiers) {
	...
	while (shift < STEP) {
		...
		while (j >= pm.getMinGain()) { // G2
			...
			Amplifier[] amplifiers = initialization.initialize(simSet.getNumberOfAmplifiers(), INPUT_POWER,
				0, simSet.getLINK_LOSSES(), function, signalTemp);
