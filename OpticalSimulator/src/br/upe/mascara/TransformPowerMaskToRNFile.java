...
public class TransformPowerMaskToRNFile {

    public static void main(String[] args) {
	PowerMask pm = PowerMaskFactory.getInstance().fabricatePowerMask(AmplifierType.EDFA_2_2_STG);

	File file = new File("EDFA_2_2_STG.txt");
	...
	for (int j = 0; j < pm.getOperatingPoints().size(); j++) {
		...
		printer.print(op.getTotalInputPower() + "\t");
