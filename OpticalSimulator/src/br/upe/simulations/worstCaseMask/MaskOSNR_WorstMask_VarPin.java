...
public class MaskOSNR_WorstMask_VarPin {
	...
	while (pinSystem >= -30.0f) {
	    int numberAmplifiers = 4;
	    SimulationSetup simSet = new SimSetAMPVOA(numberCh, pinSystem, 9.0f, numberAmplifiers, 18);
	    ...
	    System.out.println(pinSystem + " dBm/ch");
	    System.out.println("---------------------");
