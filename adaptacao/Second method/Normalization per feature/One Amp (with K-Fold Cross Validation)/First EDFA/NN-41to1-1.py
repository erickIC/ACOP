...
training_x = np.concatenate((fold_x1, fold_x2, fold_x3, fold_x4), axis = 0)
#training_y = np.concatenate((fold_y1, fold_y2, fold_y3, fold_y4), axis = 0)
...
for i in range(0, training_y.shape[0]):
    ...
    model_current.save('NN-41to1-1' + str(i+1) + '.h5')
